...
.LC2:
	...
	# DWORD PTR -48[rbp] = &filepath => rsi
	# DWORD PTR -40[rbp] = &array => r15
	# DWORD PTR -52[rbp] = max_size => r14
read_array_from_file:
	endbr64
	...
	sub	rsp, 32						# < выделение памяти для массива

	mov	r15, rdi						# / сохранение аргументов, &array
	# mov	QWORD PTR -48[rbp], rsi		# | &filepath
	mov	r14d, edx						# \ max_size
...
.L9:
	...
	mov	edx, DWORD PTR [r15+rax*4]		# / edx = array[i]
	mov	rax, QWORD PTR -16[rbp]		# | 
	lea	rsi, .LC4[rip]				# |
	mov	rdi, rax					# | FILE
	mov	eax, 0						# |

...
# Mark 4
- [ASM код исходника на С (version-0)](1-idz/version-0/) 
- [АSM код с комментариями (version-1)](1-idz/version-1/)
...
# Mark 6
- [АSM код с преимущественным использованием регистров (version-2)](1-idz/version-2/)
...
- [АSM код с комментариями (version-1)](1-idz/version-1/)
- [АSM код с преимущественным использованием регистров (version-2)](1-idz/version-2/)
- [Различные опции оптимизации](1-idz/with-optimization-flags/)
